...
export async function action({ request }) {
  ...
  const db = await connectDb();
    ...
    switch (actionState) {
      ...
      case "sortByTitle":
        return redirect("/snippetNameSortedReverse");
      case "latestSnippets":
    ...
    <div id="home">
      ...
      <div id="searchBar" className='grid grid-cols-1 mb-5 space-y-2'>
       ...
       <div id="filters" className='grid grid-cols-2 place-content-evenly gap-4 mb-5'>
        ...
        <input id="sortByTitle" name="sortByTitle" value="Z-A" type="submit" className="hover:-translate-y-2  transition hover:bg-violet-900 bg-violet-600 rounded-lg p-4" />
      ...
      <p className="mb-4"><i>Your code snippets sorted from A-Z.</i></p>
